...
from kuavo_humanoid_sdk.kuavo_strategy_pytree.utils.utils import quaternion_rotate, quaternion_multiply, quaternion_inverse
...
class Frame(str, Enum):
    ...
    ROBOT = "robot"  # 机器人坐标系
    TAG = "tag"  # AprilTag坐标系
    WAIST_YAW_LINK = "waist_yaw_link"  # 腰部yaw坐标系
